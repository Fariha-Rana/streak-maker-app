      ...
      <body className={inter.className}>
        <AuthProvider>
          <UserDataProvider>
            ...
            <main className="h-screen w-screen lg:max-w-screen bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-red-400 via-teal-100 to-cyan-900">{children}</main>
          </UserDataProvider>
        </AuthProvider>
      </body>
    </html>
